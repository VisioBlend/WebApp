...
import Bagaswir from '../assets/Autor/Bagaswir.jpg';
import Wahyu from '../assets/Autor/Wahyu.jpg';
import Steven from '../assets/Autor/Steven.jpg';
import Darly from '../assets/Autor/Darly.jpg';
    ...
    const articles = [
        {
            ...
            image: Bagaswir // Replace with actual image path
        },
        {
            title: 'Perkuat Identitas Brand Perusahaan',
            author: 'Wahyu Dika',
            time: '3 Days Ago',
            image: Wahyu // Replace with actual image path
        },
        {
            title: 'Kemampuan Fotografi Sebagai Penunjang Pemasaran Digital',
            author: 'Steven Yeun',
            time: '3 Days Ago',
            image: Steven // Replace with actual image path
        },
        {
            title: 'Peran Foto Produk Sebagai Media Promosi',
            author: 'Darly Dixon',
            time: '3 Days Ago',
            image: Darly // Replace with actual image path
        }
    ];
